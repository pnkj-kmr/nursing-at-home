...
<section class="section-padding">
  <div class="container-custom text-center">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      <a href="tel:+919211916366" class="border-2 border-white text-blue-600 hover:bg-red hover:text-red-600 font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-lg">
        {$t.cta.callNow}
      </a>
    </div>
  </div>
