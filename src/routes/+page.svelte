...
<!-- Hero Section -->
<section class="bg-gradient-to-br from-primary-50 to-red-100 section-padding">
  <div class="container-custom text-center">
    <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
      {$t.hero.title}
      <span class="text-red-600 block">{$t.hero.subtitle}</span>
    </h1>
...
<section id="services" class="section-padding bg-white">
  <div class="container-custom">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Elderly Care -->
      <div id="elderly-care" class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
      ...
      <!-- Post-Surgery Care -->
      <div id="post-surgery" class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        <div class="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mb-6">
          <svg class="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div id="chronic-care" class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        <div class="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mb-6">
          <svg class="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Palliative Care -->
      <div id="palliative" class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        <div class="w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mb-6">
          <svg class="w-8 h-8 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
          </svg>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-4">{$t.services.medicalEquipmentRent.title}</h3>
        <p class="text-gray-600 mb-6">
          {$t.services.medicalEquipmentRent.description}
        </p>
        <ul class="text-sm text-gray-600 space-y-2">
          {#each $t.services.medicalEquipmentRent.features as feature}
            <li>• {feature}</li>
          {/each}
        </ul>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-4">{$t.services.hospitalBedRent.title}</h3>
        <p class="text-gray-600 mb-6">
          {$t.services.hospitalBedRent.description}
        </p>
        <ul class="text-sm text-gray-600 space-y-2">
          {#each $t.services.hospitalBedRent.features as feature}
            <li>• {feature}</li>
          {/each}
        </ul>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-4">{$t.services.wheelchairRent.title}</h3>
        <p class="text-gray-600 mb-6">
          {$t.services.wheelchairRent.description}
        </p>
        <ul class="text-sm text-gray-600 space-y-2">
          {#each $t.services.wheelchairRent.features as feature}
            <li>• {feature}</li>
          {/each}
        </ul>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-4">{$t.services.oxygenConcentratorRent.title}</h3>
        <p class="text-gray-600 mb-6">
          {$t.services.oxygenConcentratorRent.description}
        </p>
        <ul class="text-sm text-gray-600 space-y-2">
          {#each $t.services.oxygenConcentratorRent.features as feature}
            <li>• {feature}</li>
          {/each}
        </ul>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
        ...
        <h3 class="text-xl font-semibold text-gray-900 mb-4">{$t.services.injectionService.title}</h3>
        <p class="text-gray-600 mb-6">
          {$t.services.injectionService.description}
        </p>
        <ul class="text-sm text-gray-600 space-y-2">
          {#each $t.services.injectionService.features as feature}
            <li>• {feature}</li>
          {/each}
        </ul>
      </div>
...
<section class="section-padding bg-red-50">
  <div class="container-custom">
    <div class="text-center mb-16">
    ...
    <div class="max-w-3xl mx-auto">
      <h3 class="text-2xl font-bold text-gray-900 mb-6 text-center">{$t.locations.dehradun.title}</h3>
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        <div class="text-center">
          ...
          <h4 class="text-xl font-semibold text-gray-900 mb-3">{$t.locations.dehradun.address.title}</h4>
          <p class="text-gray-700 text-lg leading-relaxed">
            {$t.locations.dehradun.address.description}
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <div class="grid grid-cols-2 gap-6">
          <div>
            <div class="text-2xl font-bold text-red-600 mb-2">100%</div>
            <div class="text-gray-600">{$t.about.stats.satisfaction}</div>
          </div>
          <div>
            <div class="text-2xl font-bold text-red-600 mb-2">5+</div>
            <div class="text-gray-600">{$t.about.stats.experience}</div>
          </div>
        </div>
      </div>
      
      <div class="bg-gradient-to-br from-red-100 to-red-200 rounded-2xl p-8">
        <div class="text-center">
          <h3 class="text-2xl font-bold text-gray-900 mb-6">{$t.about.commitment.title}</h3>
          <div class="space-y-4 text-left">
            <div class="flex items-start space-x-3">
              <div class="w-6 h-6 bg-red-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
      <div>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-start space-x-4">
            <div class="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
              <svg class="w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a2 3 0 11-6 0 3 3 0 016 0z"></path>
              </svg>
            </div>
            <div>
        ...
        <div class="mt-8 p-6 bg-red-50 rounded-lg">
          <h4 class="font-semibold text-red-900 mb-3">{$t.contact.emergency.title}</h4>
        ...
        <form class="space-y-6">
          ...
          <div>
            ...
            <select id="service" name="service" required 
              ...
              <option value="medical-equipment-rent">{$t.contact.form.medicalEquipmentRent}</option>
              <option value="hospital-bed-rent">{$t.contact.form.hospitalBedRent}</option>
              <option value="wheelchair-rent">{$t.contact.form.wheelchairRent}</option>
              <option value="oxygen-concentrator-rent">{$t.contact.form.oxygenConcentratorRent}</option>
              <option value="injection-service">{$t.contact.form.injectionService}</option>
...
<section class="section-padding">
  <div class="container-custom text-center">
    <h2 class="text-3xl md:text-4xl font-bold text-red-600 mb-6">
      {$t.cta.title}
    </h2>
    <p class="text-xl text-red-600 mb-8 max-w-2xl mx-auto">
      {$t.cta.subtitle}
    </p>
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
      <a href="#contact" class="bg-white text-red-600 hover:bg-gray-50 font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-lg">
        {$t.cta.consultation}
      </a>
      <a href="tel:+919211916366" class="border-2 border-white text-white hover:bg-white hover:text-red-600 font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-lg">
        {$t.cta.callNow}
      </a>
    </div>
  </div>
